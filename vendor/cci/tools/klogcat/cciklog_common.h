...
#define __KLOG_COMMON_H__

#define KLOG_SIGNATURE						"CCIKLOG"
#define KLOG_HEADER_VERSION					0x00010400
/*
Common Header Version Description:
ver A.B.C.D
A:reserved
B:main architecture
...
0.1.1.1		Jimmy		Initial version
0.1.2.0		Jimmy		add "SUBCRH" for subsystem crash
0.1.3.0		Jimmy		add signature and versions
0.1.3.1		Jimmy		separate operation and debug ioctls
0.1.4.0		Jimmy		add the size checking for klog header
*/
...
#define KLOG_IOCTL_GET_KLOG_VERSION				_IO(KLOG_IOCTL_ID, 0x04)
#define KLOG_IOCTL_RESTORE_LOG					_IO(KLOG_IOCTL_ID, 0x05)
#define KLOG_IOCTL_USER2KLOG_LOG					_IO(KLOG_IOCTL_ID, 0x06)
//category command
...
//debug command
#define KLOG_IOCTL_FORCE_PANIC					_IO(KLOG_IOCTL_ID, 0x21)
#define KLOG_IOCTL_FORCE_CRASH					_IO(KLOG_IOCTL_ID, 0x22)
#define KLOG_IOCTL_SET_PANIC_WHEN_SUSPEND			_IO(KLOG_IOCTL_ID, 0x23)
#define KLOG_IOCTL_SET_PANIC_WHEN_POWER_OFF			_IO(KLOG_IOCTL_ID, 0x24)
#define KLOG_IOCTL_SET_MAGIC					_IO(KLOG_IOCTL_ID, 0x25)
//CCI engmode command
...
//klog signature header(16, fixed)
#define KLOG_SIGNATURE_LENGTH					8
#define KLOG_HEADER_VERSION_LENGTH				4
#define KLOG_VERSION_LENGTH					4
#define KLOG_SIGNATURE_HEADER_LENGTH				16
...
#define KLOG_SIM_STATE_LENGTH					30
...
#define KLOG_MODEM_VERSION_LENGTH				30
#define KLOG_FLEX_VERSION_LENGTH				25
#define KLOG_RPM_VERSION_LENGTH					15
#define KLOG_BOOTLOADER_VERSION_LENGTH				40
#define KLOG_LINUX_VERSION_LENGTH				120
#define KLOG_VERSION_ID_LENGTH					70
#define KLOG_BUILD_VERSION_LENGTH				30
...
//HW info(32)
#define KLOG_PRODUCT_MODEL_LENGTH				10
#define KLOG_HW_ID_LENGTH					6
#define KLOG_CPUINFO_MAX_FREQ_LENGTH				8
#define KLOG_SCALING_MAX_FREQ_LENGTH				8
#define KLOG_HW_INFO_LENGTH					(\
									KLOG_PRODUCT_MODEL_LENGTH +\
									KLOG_HW_ID_LENGTH +\
									KLOG_CPUINFO_MAX_FREQ_LENGTH +\
									KLOG_SCALING_MAX_FREQ_LENGTH\
								)

#if (KLOG_SIGNATURE_HEADER_LENGTH + KLOG_INFO_LENGTH + KLOG_IMAGE_INFO_LENGTH + KLOG_HW_INFO_LENGTH) > CCI_KLOG_HEADER_SIZE
#error Invalid klog header size definition: KLOG_SIGNATURE_HEADER_LENGTH + KLOG_INFO_LENGTH + KLOG_IMAGE_INFO_LENGTH + KLOG_HW_INFO_LENGTH > CCI_KLOG_HEADER_SIZE
#endif // #if (KLOG_SIGNATURE_HEADER_LENGTH + KLOG_INFO_LENGTH + KLOG_IMAGE_INFO_LENGTH + KLOG_HW_INFO_LENGTH) > CCI_KLOG_HEADER_SIZE
...
enum klog_magic_index
{
	...
	KLOG_INDEX_SUBSYS_CRASH,
	KLOG_INDEX_FIQ_HANG,
	KLOG_INDEX_UNKNOWN_CRASH,
...
#define KLOG_MAGIC_UNKNOWN_CRASH				"UKNCRH"	//unknown crash(default crash type)
#define KLOG_MAGIC_MARM_FATAL					"FATALM"	//mARM fatal error
#define KLOG_MAGIC_AARM_PANIC					"PANICA"	//aARM kernel panic
#define KLOG_MAGIC_SUBSYS_CRASH					"SUBCRH"	//other sub-system crash
...
#define KLOG_PRIORITY_SUBSYS_CRASH				1
#define KLOG_PRIORITY_RPM_CRASH					4
#define KLOG_PRIORITY_FIQ_HANG					5
#define KLOG_PRIORITY_UNKNOWN_CRASH				6
#define KLOG_PRIORITY_DOWNLOAD_MODE				7
#define KLOG_PRIORITY_POWER_OFF					8
#define KLOG_PRIORITY_NATIVE_COMMAND				9
#define KLOG_PRIORITY_OEM_COMMAND				10
...
#define KLOG_STATE_SUBSYS_CRASH					0x008
...
#error Invalid klog size definition: CCI_KLOG_HEADER_SIZE + KLOG_CATEGORY_TOTAL_SIZE > CCI_KLOG_SIZE
...
{
	char		klog_signature[KLOG_SIGNATURE_LENGTH];
	unsigned int	klog_header_version;
	unsigned int	klog_version;
	...
	char		product_model[KLOG_PRODUCT_MODEL_LENGTH];
